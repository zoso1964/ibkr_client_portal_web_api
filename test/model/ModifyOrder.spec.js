...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ModifyOrder', function() {
      beforeEach(function() {
        instance = new ClientPortalWebApi.ModifyOrder();
      });

      it('should create an instance of ModifyOrder', function() {
        // TODO: update the code to test ModifyOrder
        expect(instance).to.be.a(ClientPortalWebApi.ModifyOrder);
      });
      ...
      it('should have the property auxPrice (base name: "auxPrice")', function() {
        // TODO: update the code to test the property auxPrice
        expect(instance).to.have.property('auxPrice');
        // expect(instance.auxPrice).to.be(expectedValueLiteral);
      });
