...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AllocationInnerSector', function() {
      beforeEach(function() {
        instance = new ClientPortalWebApi.AllocationInnerSector();
      });

      it('should create an instance of AllocationInnerSector', function() {
        // TODO: update the code to test AllocationInnerSector
        expect(instance).to.be.a(ClientPortalWebApi.AllocationInnerSector);
      });
