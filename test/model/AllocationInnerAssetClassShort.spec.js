...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AllocationInnerAssetClassShort', function() {
      beforeEach(function() {
        instance = new ClientPortalWebApi.AllocationInnerAssetClassShort();
      });

      it('should create an instance of AllocationInnerAssetClassShort', function() {
        // TODO: update the code to test AllocationInnerAssetClassShort
        expect(instance).to.be.a(ClientPortalWebApi.AllocationInnerAssetClassShort);
      });
