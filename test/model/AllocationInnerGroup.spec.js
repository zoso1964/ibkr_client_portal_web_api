...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AllocationInnerGroup', function() {
      beforeEach(function() {
        instance = new ClientPortalWebApi.AllocationInnerGroup();
      });

      it('should create an instance of AllocationInnerGroup', function() {
        // TODO: update the code to test AllocationInnerGroup
        expect(instance).to.be.a(ClientPortalWebApi.AllocationInnerGroup);
      });
