...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CalendarRequestDate', function() {
      beforeEach(function() {
        instance = new ClientPortalWebApi.CalendarRequestDate();
      });

      it('should create an instance of CalendarRequestDate', function() {
        // TODO: update the code to test CalendarRequestDate
        expect(instance).to.be.a(ClientPortalWebApi.CalendarRequestDate);
      });
