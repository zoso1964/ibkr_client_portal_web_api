...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse500', function() {
      beforeEach(function() {
        instance = new ClientPortalWebApi.InlineResponse500();
      });

      it('should create an instance of InlineResponse500', function() {
        // TODO: update the code to test InlineResponse500
        expect(instance).to.be.a(ClientPortalWebApi.InlineResponse500);
      });
