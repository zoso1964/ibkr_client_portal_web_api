...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClientPortalWebApi.AccountApi();
  });
  ...
  describe('(package)', function() {
    describe('AccountApi', function() {
      ...
      describe('iserverAccountPost', function() {
        it('should call iserverAccountPost successfully', function(done) {
          // TODO: uncomment, update parameter values for iserverAccountPost call and complete the assertions
          /*
          var body = new ClientPortalWebApi.SetAccount();
          body.acctId = "";

          instance.iserverAccountPost(body, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(ClientPortalWebApi.InlineResponse2001);
            expect(data.set).to.be.a('boolean');
            expect(data.set).to.be(false);
      ...
      describe('iserverAccountsGet', function() {
        it('should call iserverAccountsGet successfully', function(done) {
          // TODO: uncomment iserverAccountsGet call and complete the assertions
          /*

          instance.iserverAccountsGet(function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(ClientPortalWebApi.InlineResponse200);
            {
            ...
            expect(data.aliases).to.be.a(Object);
            expect(data.aliases).to.be();
            expect(data.selectedAccount).to.be.a('string');
            expect(data.selectedAccount).to.be("");
