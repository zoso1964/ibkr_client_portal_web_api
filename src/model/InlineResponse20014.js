...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    module.exports = factory(require('../ApiClient'), require('./Position'));
  } else {
    // Browser globals (root is window)
    if (!root.ClientPortalWebApi) {
      root.ClientPortalWebApi = {};
    }
    root.ClientPortalWebApi.InlineResponse20014 = factory(root.ClientPortalWebApi.ApiClient, root.ClientPortalWebApi.Position);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('ACCTID'))
        obj.ACCTID = Position.constructFromObject(data['ACCTID']);
    }
    return obj;
  }

  /**
   * @member {module:model/Position} ACCTID
   */
