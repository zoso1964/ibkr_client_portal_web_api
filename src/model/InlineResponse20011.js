...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ClientPortalWebApi.InlineResponse20011 = factory(root.ClientPortalWebApi.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('acctId'))
        obj.acctId = ApiClient.convertToType(data['acctId'], Object);
    }
    return obj;
  }

  /**
   * @member {Object} acctId
   */
