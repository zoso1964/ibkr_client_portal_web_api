...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ClientPortalWebApi.ApiClient = factory(root.superagent, root.querystring);
  }
  ...
  var exports = function() {
     ...
     * @type {String}
     * @default https://localhost:5000/v1/portal
     */
    this.basePath = 'https://localhost:5000/v1/portal'.replace(/\/+$/, '');
